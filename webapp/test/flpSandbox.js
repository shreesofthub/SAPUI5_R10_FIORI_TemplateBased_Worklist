					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Display workList Fiori like application",
									"targetURL": "#r10worklist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"r10worklist-display": {
								"semanticObject": "r10worklist",
								"action": "display",
								"description": "Display workList Fiori like application",
								"title": "Display workList Fiori like application",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=r10worklist",
									"url": sap.ui.require.toUrl("r10worklist")
								}
							}
						}
					}
